...
export function Income({ incomes, loading, onCreate, onUpdate, onDelete }: { incomes: IncomeRecord[]; loading: boolean; onCreate: (income: IncomeInput) => Promise<void>; onUpdate: (id: string, income: IncomeInput) => Promise<void>; onDelete: (id: string) => Promise<void> }) {
